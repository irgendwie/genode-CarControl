...
class SensorDataOut : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:protobuf.SensorDataOut) */ {
 public:
  ...
  // float brakeFL = 16;
  void clear_brakefl();
  static const int kBrakeFLFieldNumber = 16;
  float brakefl() const;
  void set_brakefl(float value);

  // float brakeFR = 17;
  void clear_brakefr();
  static const int kBrakeFRFieldNumber = 17;
  float brakefr() const;
  void set_brakefr(float value);

  // float brakeRL = 18;
  void clear_brakerl();
  static const int kBrakeRLFieldNumber = 18;
  float brakerl() const;
  void set_brakerl(float value);

  // float brakeRR = 19;
  void clear_brakerr();
  static const int kBrakeRRFieldNumber = 19;
  float brakerr() const;
...
// float brakeFL = 16;
inline void SensorDataOut::clear_brakefl() {
  brakefl_ = 0;
}
inline float SensorDataOut::brakefl() const {
  // @@protoc_insertion_point(field_get:protobuf.SensorDataOut.brakeFL)
  return brakefl_;
}
inline void SensorDataOut::set_brakefl(float value) {
  
  brakefl_ = value;
  // @@protoc_insertion_point(field_set:protobuf.SensorDataOut.brakeFL)
}

// float brakeFR = 17;
inline void SensorDataOut::clear_brakefr() {
  brakefr_ = 0;
}
inline float SensorDataOut::brakefr() const {
  // @@protoc_insertion_point(field_get:protobuf.SensorDataOut.brakeFR)
  return brakefr_;
}
inline void SensorDataOut::set_brakefr(float value) {
  
  brakefr_ = value;
  // @@protoc_insertion_point(field_set:protobuf.SensorDataOut.brakeFR)
}

// float brakeRL = 18;
inline void SensorDataOut::clear_brakerl() {
  brakerl_ = 0;
}
inline float SensorDataOut::brakerl() const {
  // @@protoc_insertion_point(field_get:protobuf.SensorDataOut.brakeRL)
  return brakerl_;
}
inline void SensorDataOut::set_brakerl(float value) {
  
  brakerl_ = value;
  // @@protoc_insertion_point(field_set:protobuf.SensorDataOut.brakeRL)
}

// float brakeRR = 19;
inline void SensorDataOut::clear_brakerr() {
  brakerr_ = 0;
}
inline float SensorDataOut::brakerr() const {
  // @@protoc_insertion_point(field_get:protobuf.SensorDataOut.brakeRR)
  return brakerr_;
}
inline void SensorDataOut::set_brakerr(float value) {
  
  brakerr_ = value;
  // @@protoc_insertion_point(field_set:protobuf.SensorDataOut.brakeRR)
}
